...
filelist2=(${dir_code}/MyLibs/include/Point.h ${dir_code}/MyLibs/include/Map.h ${dir_code}/MyLibs/include/Array2D.h ${dir_code}/MyLibs/include/DisAzi.h ${dir_code}/MyLibs/sources/Map/Map.cpp ${dir_code}/MyLibs/include/StaList.h ${dir_code}/MyLibs/include/MyOMP.h ${dir_code}/MyLibs/include/StackTrace.h ${dir_code}/MyLibs/include/Parabola.h ${dir_code}/MyLibs/include/VectorOperations.h ${dir_code}/Programs/RadPattern/RadPattern_C/RadPattern.h ${dir_code}/Programs/RadPattern/RadPattern_C/RadPattern.cpp ${dir_code}/MyLibs/include/mysac64.h ${dir_code}/MyLibs/include/SacRec.h ${dir_code}/MyLibs/sources/SacRec/SacRec.cpp)
