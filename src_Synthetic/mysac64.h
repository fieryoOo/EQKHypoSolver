...
struct SAC_HD {
	float	delta; mutable float depmin, depmax; float scale, odelta;    //0 - 4
	...
	mutable int	nzyear, nzjday, nzhour,    nzmin,     nzsec;     
	mutable int nzmsec, internal4; int internal5, internal6, npts;      
	int	internal7, internal8, unused13,  unused14,  unused15;  
	mutable int iftype; int idep, iztype,  unused16,  iinst;     
	...
	mutable int leven, lpspol, lovrok; int lcalda,    unused27;  
